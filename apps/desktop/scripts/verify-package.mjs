...
export const requiredFiles = [
  ...
  "skills/prep/arcane-fvtt-server/SKILL.md",
  "skills/prep/arcane-fvtt-server/references/ssh-onboarding.md",
  "skills/prep/arcane-fvtt-server/references/vendor-map.md",
