...
const mutations=[
 ...
 ['A1','spells.prepared',a=>a.raw.items.find(i=>i.system.identifier==='shield').system.prepared=0],
 ...
 ['A3','domain.bless',a=>a.raw.items.find(i=>i.system.identifier==='bless').system.prepared=1],
