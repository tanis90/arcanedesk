...
function selectVerifier(version){
  const file={v2:'./verify.cjs',v3:'./verify-v3.cjs',v4:'./verify-v4.cjs'}[version];
  ...
  const dependencies=['v3','v4'].includes(version)?['./policy.cjs','./source-aliases-v3.json','./spell-metadata.json']:['./policy.cjs'];
  if(version==='v4')dependencies.push('./verify-v3.cjs');
