...
function fixture(){
  const source={type:'spell',system:{identifier:'bless',level:1,activities:[{type:'utility',duration:{concentration:true},consumption:{spellSlot:true}}]},toObject(){return {system:this.system,effects:[]};}};
