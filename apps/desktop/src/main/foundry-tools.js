...
export function createFoundryTools(host) {
  ...
  return [
    ...
    actorWrite("foundry_actor_advance", "actorAdvance", exact({ actorUuid: ref(), readRef: ref(), classUuid: ref(), subclassUuid: Type.Optional(ref()), raceUuid: Type.Optional(ref()), targetLevel: Type.Integer({ minimum: 1, maximum: 20 }), choices: Type.Optional(exact({ bySlot: Type.Optional(Type.Record(ref(), Type.Union([Type.Array(ref(), { maxItems: 20, uniqueItems: true }), exact({ abilityScore: Type.Optional(Type.Record(ref(), Type.Integer({ minimum: 1, maximum: 2 }))), feat: Type.Optional(ref()) })]))), hp: Type.Optional(Type.Union([Type.Literal("max"), Type.Literal("avg")])) })), additionalItems: Type.Optional(Type.Array(grant, { maxItems: 50 })) }),
