...
The maintained module now lives in `apps/foundry-webmcp`, uses the module ID
`arcane-webmcp`, and resolves `@arcanedesk/foundry-sdk` from the workspace. See
the parent [`README`](../README.md) for current build and installation commands.
